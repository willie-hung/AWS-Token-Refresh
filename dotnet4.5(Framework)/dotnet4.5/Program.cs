...
namespace AWS_Refresh_Token
{
    class Program
    {
        static async Task Main()
        {
            var ssoOidcClient = new AmazonSSOOIDCClient(new AnonymousAWSCredentials(), new AmazonSSOOIDCConfig { RegionEndpoint = RegionEndpoint.USWest2 }); //Change your AWS region
            ...
            var startDeviceAuthResponse = await ssoOidcClient.StartDeviceAuthorizationAsync(new StartDeviceAuthorizationRequest
            {
                ...
                StartUrl = "Enter_YourURL_here!" //Change your URL
            });
            ...
            {
                List<string> accountID = new List<string> { "XXX", "YYY" }; //Change your AccountID here
